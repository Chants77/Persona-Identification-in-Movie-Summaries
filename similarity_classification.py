...
import pandas as pd
import numpy as np
from transformers import AutoTokenizer, AutoModelForCausalLM, LongformerModel, LongformerTokenizer, BigBirdModel, BigBirdTokenizer
...
SEED = 42
embedding_mode = 1 # 1: llama-gen 2: longformer-cls 3: longformer-mask 4: bigbird-cls 5: bigbird-mask 6: ling_sent
...
if embedding_mode == 1:
    ...
    model.eval()
elif embedding_mode == 2 or embedding_mode == 3:
    ...
    model.eval()
elif embedding_mode == 4 or embedding_mode == 5:
    ...
    with torch.inference_mode():
        for category in tqdm(categories, desc="Categories"):
            ...
            if mode == 1:
                ...
                prompt_text = f"Describe the key characteristics of {clean_category}."
                inputs = tokenizer(
                    prompt_text,
